...
const TextValuesCreateApplication = {
  [ACCESS_APPLICATION.NoRight]:
    'В двух предыдущих календарных годах вы не находились в отпуске по беременности и родам и/или по уходу за ребёнком',
  [ACCESS_APPLICATION.ToApply]: `Ранее вы предоставили справку 182н, если вы находились в декрете или отпуске по уходу за ребёнком у другого работодателя, пожалуйста, свяжитесь с Отделом расчёта заработной платы и иных выплат для уточнения возможности и порядка оформления заявления на замену лет для расчёта больничного
  ...
  [ACCESS_APPLICATION.NeedOriginalReference]:
    'Если в двух предыдущих годах, предшествующих году начала заболевания, вы работали у других работодателей и находились в отпуске по беременности и родам и/или по уходу за ребёнком, то для расчёта больничного необходимо предоставить оригинал справки 182н в ОРЗПиИВ (г. Москва, ул. Трубная, д. 2, к. 511).',
